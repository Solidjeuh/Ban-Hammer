...
$lang = array_merge($lang, array(
	...
	'ACP_DEL_PRIVMSGS'	=> 'Verwijder gebruikers priv&eacute;berichten',
	...
	'ACP_MOVE_GROUP_EXPLAIN'	=> 'Naam van de groep waarnaar gebannen gebruikers moeten worden verplaatst. Dit is ook hun standaard groep.<br /><strong>Indien er niets buiten: <em>“Geen groep opgegeven.”</em> verschijnt in de keuzelijst, hebt geen groepen ingesteld.</strong>',
	'BAN_LENGTH_EXPLAIN'	=> 'Als &eacute;&eacute;n van de verban opties is ingesteld, wordt de gebruiker verbannen gedurende de tijd die hier is ingesteld. Dit kan ook ingesteld worden bij: Gebruik de ban hamer voor deze gebruiker.',
	'SETTINGS_ERROR'		=> 'Er is een fout opgetreden bij het opslaan van uw instellingen. Voer de backtrace in met uw foutenrapport.',
